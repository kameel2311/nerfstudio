...
def so2_experimental(tangent_vector: Float[Tensor, "b 6"]) -> Float[Tensor, "b 3 4"]:
    """Compute the exponential map of the direct product group `SO(2)`.

    This is an experimental function that only computes the rotation part of the transformation matrix.
    ...
    Returns:
        [R|t] transformation matrices.
    """
    # Override delta to only x and y translation
